  ...
  RSpec.describe Lox::Interpreter::ExpressionEvaluator do
    ...
    context 'Statement Execution' do
      ...
      it 'executes class instantiation and property setting' do
        ...
        class_stmt = Lox::Syntax::Stmt::Class.new(class_token, nil, [])
        var_token = Lox::Lexical::Token.new(Lox::Lexical::TokenType::IDENTIFIER, 'x', nil, 1)
        call_expr = Lox::Syntax::Expr::Call.new(Lox::Syntax::Expr::Variable.new(class_token),
        ...
        set_stmt = Lox::Syntax::Stmt::Expression.new(Lox::Syntax::Expr::Set.new(
                                                       Lox::Syntax::Expr::Variable.new(var_token), prop_token, Lox::Syntax::Expr::Literal.new('test')
                                                     ))
