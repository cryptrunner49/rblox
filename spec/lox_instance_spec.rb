...
module Spec
  RSpec.describe Lox::Interpreter::LoxInstance do
    # ======================================================================
    # Section: LoxInstance Tests
    # Purpose: Contains tests to verify the functionality of LoxInstance.
    # ======================================================================
    ...
    it 'raises error for undefined property' do
      ...
      expect do
        instance.get(prop_token)
      end.to raise_error(Lox::Interpreter::RuntimeError, "Undefined property 'missing'.")
    end
